...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
      ...
      },{id: "books-the-perfect-child",
          title: 'The Perfect Child',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/the_perfect_child/";
            },},{id: "books-red-rising",
          title: 'Red Rising',
          description: "",
          section: "Books",handler: () => {
          ...
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/anathem/";
          ...
          description: "",
          section: "News",},{id: "news-selected-for-google-india-s-2026-summer-internship",
          title: 'Selected for Google India’s 2026 Summer Internship!',
          description: "",
          section: "News",},{id: "news-i-presented-my-first-paper-mcp-diag-a-deterministic-protocol-driven-architecture-for-ai-native-network-diagnostics-at-ieee-comsnets-2026-and-received-the-best-graduate-forum-paper-runner-up-award",
          title: 'I presented my first paper, “MCP-Diag: A Deterministic, Protocol-Driven Architecture for AI-Native Network...',
          description: "",
          section: "News",},{id: "news-made-it-to-semester-5-s-dean-s-list-letter-of-appreciation",
          title: 'Made it to Semester-5’s Dean’s List! (Letter of Appreciation)',
          description: "",
          section: "News",},{id: "news-i-will-be-speaking-about-embedded-systems-in-rust-at-rust-india-conference-2026",
          title: 'I will be speaking about Embedded Systems in Rust at Rust India Conference...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://mastodon.social/@devanshlodha", "_blank");
        },
      },{
        id: 'social-bluesky',
        title: 'Bluesky',
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/devansh-lodha.bsky.social", "_blank");
        },
      },{
        id: 'social-discord',
        title: 'Discord',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://gitlab.com/devansh-lodha", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0001-1399-9592", "_blank");
        },
      },{
        id: 'social-osf',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://osf.io/dmqb6/", "_blank");
        },
      },{
        id: 'social-publons',
        title: 'Publons',
        section: 'Socials',
        handler: () => {
          window.open("https://publons.com/a/PII-3796-2026/", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.researchgate.net/profile/https://www.researchgate.net/profile/Devansh-Lodha-2/", "_blank");
        },
      },{
        id: 'social-kaggle',
        title: 'Kaggle',
        section: 'Socials',
        handler: () => {
          window.open("https://www.kaggle.com/devanshlodha", "_blank");
        },
      },{
        id: 'social-facebook',
        title: 'Facebook',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://wa.me/917016784377", "_blank");
        },
      },{
        id: 'social-youtube',
        title: 'YouTube',
        section: 'Socials',
        handler: () => {
          window.open("https://youtube.com/@devansh-lodha", "_blank");
        },
      },{
      id: 'light-theme',
